...
class ActionProviderInput(BaseModel):
    ...
    fastText_predictions: str = Field(
        ..., title="fastText predictions", description="A new line delinated file containing fastText predictions"
    )
    langdetect_predictions: str = Field(
        ..., title="langdetect predictions", description="A new line delinated file containing langdetect predictions"
    )
    primary_validation: str = Field(
        ..., title="Primary validation", description="A new line delinated file containing ground truth"
    )
    ...
    class Config:
        schema_extra = {
            "fastText_predictions": {
                "example": "fastText_predictions.txt",
                },
            "langdetect_predictions": {
                "example": "langdetect_predictions.txt",
                },
            "primary_validation": {
                "example": "primary_validation.txt",
                },
            }
...
description = ActionProviderDescription(
    ...
    api_version="1.0",
    subtitle="Generates statistics, figures, and tables comparing LiD accuracy to ground truth",
    description="A simple LPAP, ingesting data from fastText and langdetect lid methods to compare their accuracy to ground truth.",
    keywords=["LiD", "Statistics", "Accuracy", "Language Identification"],
    visible_to=["public"],
